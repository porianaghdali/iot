...
import DoughnutChart from "@/components/utils/charts/doughnut";
      ...
      <div className="flex gap-1.5">
        {cards.map((item) => {
          return (
            ...
            >
              <p className="py-0.5 text-center bg-white border border-[#0000000D] text-[#2A2A2A] font-normal text-[10px]">
                {item.title}
              </p>
              <p className="py-3 text-center bg-white border border-[#0000000D] text-[#2A2A2A] font-normal text-[10px]">
                {item.value}
              </p>
