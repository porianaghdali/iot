    ...
    <div className="bg-white rounded-xs px-3 py-3.5 flex justify-between w-72 h-fit">
      <div className="w-full h-full border border-dashed border-[#0000001A] rounded-md py-3 flex flex-col items-center gap-2">
        ...
        <div className="grid gap-2 ">
          <p className="text-sm font-normal text-[#606060] text-center">
            ابزارک خودت رو بساز
          </p>
          <button className="text-white w-full text-sm font-normal bg-[#0D0D0D] rounded-[50px] py-1.5 mx-auto px-3">
            ساخت ابزارک
          </button>
        </div>
      </div>
